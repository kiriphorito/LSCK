    ...
    public class WebsiteGenerator
    {
        ...
        public void GenerateWebsite()
        {
            ...
            if (CDN == false)
            {
                ...
                File.Copy(Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"Assets/bootstrap.min.css"), generateDir + @"/styles/bootstrap.min.css");
                Directory.CreateDirectory(generateDir + @"/styles/ace");
                string sourcePath = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), @"Assets/ace");
